            ...
            <div class="row" style="margin-top:20px;">
              ...
              <div class="col-md-9">
                <div class="form-group">
                  ...
                  <button type="button" class="btn btn-default" onclick="resetFilter()" style="margin-left:5px;">
                    <i class="fa fa-refresh"></i> Reset
                  </button>
                  <button type="button" class="btn btn-success" onclick="window.print();" style="margin-left:5px;">
                    <i class="fa fa-print"></i> Print
                  </button>
                  <span class="help-block" style="display:inline-block; margin-left:15px; margin-bottom:0;">
                    <strong>Total:</strong> <?php echo count($qrcode); ?> |
                    <strong>Selected:</strong> <span id="selected_count"><?php echo count($qrcode); ?></span>
                  </span>
                </div>
              </div>
            </div>
