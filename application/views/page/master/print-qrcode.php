             ...
             ?>
                <tr>
                    ...
                    <td class="text-center qrsize">  
                        ...
                        <br />
                        <strong class="text-sm"><?php echo strtolower($qrcode[($k+1)]['qr_code_ctnt']);?></strong>
                        <?php } ?>
                    </td>
                    <td class="text-center">  
                        ...
                        <br />
                        <strong class="text-sm"><?php echo strtolower($qrcode[($k+2)]['qr_code_ctnt'])?></strong>
                        <?php } ?>
                    </td>
                    <td class="text-center">  
                        ...
                        <br />
                        <strong class="text-sm"><?php echo strtolower($qrcode[($k+3)]['qr_code_ctnt'])?></strong>
                        <?php } ?>
                    </td> 
                    <td class="text-center">  
                        ...
                        <br />
                        <strong class="text-sm"><?php echo strtolower($qrcode[($k+4)]['qr_code_ctnt'])?></strong>
                        <?php } ?>
                    </td> 
                </tr>    
             <?php $k+=5; } ?> 
    ...
    <?php 
     ...
     <tr>
        <td class="text-center" style="width: 39mm;height:35mm;">
            <?php if(isset($qrcode[($k)])) {?>
            <img src="<?php echo base_url($qrcode[($k)]['qr_path'])?>" class="img" style="width: 35mm;height:30mm;"  /> 
             <p class="text-sm"><?php echo strtolower($qrcode[($k)]['qr_code_ctnt'])?></p>
            <?php } ?>
        </td>
        <td class="text-center" style="width: 39mm;height:35mm;">
            <?php if(isset($qrcode[($k+1)])) {?>
            <img src="<?php echo base_url($qrcode[($k+1)]['qr_path'])?>" class="img" style="width: 35mm;height:30mm;"  /> 
            <p class="text-sm"><?php echo strtolower($qrcode[($k+1)]['qr_code_ctnt'])?></p>
            <?php } ?>
        </td>
        <td class="text-center" style="width: 39mm;height:35mm;">
            <?php if(isset($qrcode[($k+2)])) {?>
            <img src="<?php echo base_url($qrcode[($k+2)]['qr_path'])?>" class="img" style="width: 35mm;height:30mm;"  /> 
            <p class="text-sm"><?php echo strtolower($qrcode[($k+2)]['qr_code_ctnt'])?></p>
            <?php } ?>
        </td>
        <td class="text-center" style="width: 39mm;height:35mm;">
            <?php if(isset($qrcode[($k+3)])) {?>
            <img src="<?php echo base_url($qrcode[($k+3)]['qr_path'])?>" class="img" style="width: 35mm;height:30mm;"  /> 
            <p class="text-sm"><?php echo strtolower($qrcode[($k+3)]['qr_code_ctnt'])?></p>
            <?php } ?>
        </td>
        <td class="text-center" style="width: 39mm;height:35mm;">
            <?php if(isset($qrcode[($k+4)])) {?>
            <img src="<?php echo base_url($qrcode[($k+4)]['qr_path'])?>" class="img" style="width: 35mm;height:30mm;"  /> 
