    ...
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 20px;">
            <div class="login-logo">
                ...
                <img src="<?php echo base_url() ?>asset/images/the_aalam_logo.png" class="img-rounded img-responsive"
                    alt="<?php echo PG_HEAD;?>">
            </div>
            <div class="login-logo1 text-center">
                <!-- <h2 class="text-blue"><?php //echo PG_HEAD;?></h2> -->
                <img src="<?php echo base_url() ?>asset/images/Classwall-VS.png" class="img-rounded img-thumbnail no-border" width="40%"
                    alt="<?php echo PG_HEAD;?>">
