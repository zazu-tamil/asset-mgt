...
<section class="content"> 
  <!-- Default box -->
    <div class="box box-info"> 
        ...
        <div class="box-body">
             <form method="post" action="<?php echo site_url('cash-outward-list')?>" id="frmsearch">          
             <div class="row">   
                 <div class="form-group col-md-3"> 
                    ...
                    <div class="input-group date">
                      ...
                      <input type="date" class="form-control pull-right" id="srch_from_date" name="srch_from_date" value="<?php echo set_value('srch_from_date',$srch_from_date);?>">
                    </div>
                    <!-- /.input group -->                                             
                 </div> 
                 <div class="form-group col-md-3"> 
                    ...
                    <div class="input-group date">
                      ...
                      <input type="date" class="form-control pull-right" id="srch_to_date" name="srch_to_date" value="<?php echo set_value('srch_to_date',$srch_to_date);?>">
                    </div>
                    <!-- /.input group -->                                             
                 </div>
          ...
          <tbody>
               <?php  foreach($record_list as $j=> $ls){  ?> 
                <tr> 
                    ...
                    <td class="text-center"><?php echo $ls['prefix'] . $ls['vno'];?><br /><i class="label label-info"><?php echo $ls['voucher_type_name']?></i></td> 
                    <td><?php echo date('d-m-Y', strtotime($ls['outward_date']))?><br /><?php echo $ls['ac_type']?></td>  
                    ...
                    <td class="text-center"><?php if(!empty($ls['bill_photo'])) echo "<a href='". base_url($ls['bill_photo']) ."' target='_blank'>View</a><br><i class='badge'>" . $ls['bill_type']."</i>"; ?></td>   
                     
                    <td class="text-center">
                        <?php if(($this->session->userdata('cr_user_type') == "Admin" )|| (($this->session->userdata('cr_user_type') != 'Admin' ) && ($ls['days'] <= EDIT_ALLOW_DAYS) && ($this->session->userdata('cr_edit_flg') == '1' ))) {  ?>
                        <button data-toggle="modal" data-target="#edit_modal" value="<?php echo $ls['cash_outward_id']?>" class="edit_record btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></button>
                        <?php } ?> 
                    </td>  
                    <td class="text-center">
                        <a href="<?php echo site_url('print-voucher/' . $ls['cash_outward_id'] ) ; ?>" target="_blank" class="btn btn-success btn-xs" title="Print Voucher"><i class="fa fa-print"></i></a>
                    </td>   
                                                 
                    <td class="text-center">
                        <?php if(($this->session->userdata('cr_user_type') == "Admin" )|| (($this->session->userdata('cr_user_type') != 'Admin' ) && ($ls['days'] <= EDIT_ALLOW_DAYS))) {  ?>
                        <button value="<?php echo $ls['cash_outward_id']?>" class="del_record btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button>
                        <?php } ?> 
                    </td>  
                                     ...
                                     <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group date">
                                          <div class="input-group-addon">
                                            ...
                                            <input class="form-control datepicker" type="text" name="outward_date" id="outward_date" value="<?php echo date('Y-m-d');?>" required="true">
                                        </div>                                              
                                     </div> 
                                     <div class="form-group col-md-6">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body"> 
                                 ...
                                 <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        ...
                                        <input class="form-control datepicker" type="text" name="outward_date" id="outward_date" value="" required="true">
                                    </div>                                              
                                 </div>
                                 <div class="form-group col-md-3">
                                    <label>V.No</label>
                                    <input class="form-control text-right" type="number" step="any" name="vno" id="vno" value="" required="true">                                             
                                 </div>
                                 <div class="form-group col-md-6">
                                    <label>Account Group</label>
                                    <?php echo form_dropdown('ac_type',array('' => 'Select') + $ac_type_opt ,set_value('ac_type') ,' id="ac_type" class="form-control" required="true"');?>                                             
                                 ...
                                 <div class="form-group col-md-6">
                                    <label>Bill Photo Upload</label>
                                    <input class="form-control" type="file"  name="bill_photo" id="bill_photo">                                             
                                    <input class="form-control" type="hidden"  name="bill_photo_path" id="bill_photo_path">                                             
                                 </div> 
                                 <div class="form-group col-md-6">
                                        <label>Voucher Type</label>
                                        <?php echo form_dropdown('voucher_type_id',array('' => 'Select') + $voucher_type_opt ,set_value('voucher_type_id') ,' id="voucher_type_id" class="form-control" required="true"');?>                                             
