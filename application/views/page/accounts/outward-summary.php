<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Outward Summary</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Reports</a></li> 
    <li class="active">Outward Summary</li>
  </ol>
</section>
<!-- Main content -->
<section class="content"> 
  <!-- Default box -->
    <div class="box box-info no-print"> 
        ...
        <div class="box-body">
             <form method="post" action="<?php echo site_url('outward-summary')?>" id="frmsearch">          
             <div class="row">   
  ...
  <div class="box box-info">
    <div class="box-header with-border">
        <h4>Outward Summary : [ <?php echo date('M-Y', strtotime($srch_from_date));?> to <?php echo date('M-Y', strtotime($srch_to_date));?> ]  </h4>     
    </div>
    <div class="box-body table-responsive"> 
        <div class="row">
                <?php foreach($outward_rec as $ac_typ => $info) {?>
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                          ...
                          <i class="badge pull-right">Outward</i>
                        </div>
                        <div class="box-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <?php   
                                        if(isset($ls[$mon]['outward'])){
                                        $tot[$n_mon] += $ls[$mon]['outward'];
                                        $htot += $ls[$mon]['outward'];
                                        }
                                    ?>
                                    <td class="text-right"> <?php if(isset($ls[$mon]['outward'])) echo number_format($ls[$mon]['outward'],2); else echo '0.00'?></td> 
                                    <?php } ?> 
