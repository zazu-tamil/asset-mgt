...
<div class="wrapper" > 
   <div class="container" style="padding-bottom: 30px;"> 
            ...
            <tr>
                 <td class="text-center" width="70%">
                    <div>
                        ...
                        <div class="col-lg-9"><h2>Receipt</h2></div>
                    </div>
                 </td>
                 <td class="text-center">
                    <b>Receipt No :- <?php echo $record_list['prefix'] . $record_list['vno']. "/" . $record_list['fyr'];?></b> <hr />
                    <b>Date :- <?php echo date('d-m-Y', strtotime($record_list['inward_date'])) ;?></b>
                 </td>
            </tr>
            <tr>
                <td colspan="2" class="text-left">Received from <?php echo $record_list['account_head_name'];?> , <?php echo $record_list['sub_account_head_name'];?></td>
            </tr>
            <tr>
    ...
    <div class="container" style="padding-bottom: 30px;"> 
        <table class="table table-bordered invoice">
            <tr>
                 <td class="text-center" width="50%"><h2>Receipt </h2></td>
                 <td class="text-center">
                    <b>Receipt No :- <?php echo $record_list['prefix'] . $record_list['vno']. "/" . $record_list['fyr'];?></b> <hr />
                    <b>Date :- <?php echo date('d-m-Y', strtotime($record_list['inward_date'])) ;?></b>
                 </td>
