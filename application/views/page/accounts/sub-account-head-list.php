<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Sub Account Head List</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Petty Cash</a></li> 
    <li class="active">Sub Account Head List</li>
  </ol>
</section>
<!-- Main content -->
               ...
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center">
                        <button data-toggle="modal" data-target="#edit_modal" value="<?php echo $ls['sub_account_head_id']?>" class="edit_record btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></button>
                    </td>                                  
                    <td class="text-center">
                        <button value="<?php echo $ls['sub_account_head_id']?>" class="del_record btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button>
                    </td>                                      
                </tr>
                <?php
                    }
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <h3 class="modal-title" id="scrollmodalLabel">Add Sub Account Head Info</h3>
                            ...
                            <div class="modal-body">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="sub_account_head_name" id="sub_account_head_name" value="">                                             
                                 </div>  
                                 <div class="form-group">
                                    <label>Status</label>
                                    <div class="radio">
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header"> 
                                ...
                                <h3 class="modal-title" id="scrollmodalLabel">Edit Sub Account Head Info</h3>
                                <input type="hidden" name="mode" value="Edit" />
                                <input type="hidden" name="sub_account_head_id" id="sub_account_head_id" />
                            </div>
                            <div class="modal-body"> 
                                <div class="form-group">
                                    <label>Account Type</label>
