          ...
          <tbody>
               <?php  foreach($record_list as $j=> $ls){  ?> 
                <tr> 
                    ...
                    <td><?php echo date('d-m-Y', strtotime($ls['inward_date']))?><br /><?php echo $ls['ac_type']?></td>  
                    ...
                    <td class="text-center">
                        <a href="<?php echo site_url('print-receipt/' . $ls['cash_inward_id'] ) ; ?>" target="_blank" class="btn btn-success btn-xs" title="Print Receipt"><i class="fa fa-print"></i></a>
                    </td>                               
                    <td class="text-center">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        ...
                                        <input class="form-control datepicker" type="text" name="inward_date" id="inward_date" value="<?php echo date('Y-m-d');?>" required="true">
                                    </div>                                              
                                 </div> 
                                 <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group date">
                                      <div class="input-group-addon">
                                        ...
                                        <input class="form-control datepicker" type="text" name="inward_date" id="inward_date" value="" required="true">
                                    </div>                                              
                                 </div> 
                                 <div class="form-group col-md-3">
                                    <label>V.No</label>
